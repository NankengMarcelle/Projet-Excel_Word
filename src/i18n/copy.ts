...
export const copy = {
  fr: {
    ...
    loadingSessionMsg: "Vérification de la session...",
    ...
    childSheetsMenuLabel: "Feuilles enfants",
    addAnotherSheetLabel: "Ajouter une autre feuille",
    removeSheetLabel: "Retirer la feuille",
    columnCountMismatchError: "Toutes les feuilles sélectionnées doivent sélectionner le même nombre de colonnes",
  ...
  en: {
    ...
    loadingSessionMsg: "Checking your session...",
    ...
    childSheetsMenuLabel: "Child sheets",
    addAnotherSheetLabel: "Add another sheet",
    removeSheetLabel: "Remove sheet",
    columnCountMismatchError: "All selected sheets must select the same number of columns",
